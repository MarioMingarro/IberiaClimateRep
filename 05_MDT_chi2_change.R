...
# 1. Cargar rasters
r_n2000 <- rast("C:/A_TRABAJO/IberiaClimateRep_RES/SSP370/04_metrics/N2000CRS_stable.tif")
r_er    <- rast("C:/A_TRABAJO/IberiaClimateRep_RES/SSP370/04_metrics/N2000CRS_present.tif")
